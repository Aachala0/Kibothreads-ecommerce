          ...
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
              ...
              <Tab>
                <button
                  type="button"
                  className="font-medium border-b-2 border-orange-500 bg-[#605d5d12] text-orange-400  hover:shadow-orange-700  rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]    px-5 py-1.5 text-center "
                >
                  <div className="flex gap-2 items-center">
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    onClick={add}
                    type="button"
                    className="focus:outline-none text-white bg-orange-400 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-orange-500 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
                    style={{
